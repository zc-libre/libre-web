          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              <el-form label-position="left" inline class="demo-table-expand">
                ...
                <el-form-item v-if="props.row.lineNumber" label="行数">
...
<script>
  import { getError, getErrorDetail } from '@/api/log'
  ...
  export default {
    ...
    methods: {
      ...
      async info(id) {
        const { data } = await getErrorDetail(id)
        this.errorInfo = data.stackTrace
        this.dialog = true
      },
      async fetchData() {
        this.listLoading = true
        const res = await getError(this.queryForm)
